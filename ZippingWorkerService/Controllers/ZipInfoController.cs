...
namespace ZippingWorkerService.Controllers
{
    ...
    public class ZipInfoController : ControllerBase
    {
        ...
        private static ArchiveCompressionLevel MapCompressionLevel(CompressionLevelEnumType level)
        {
            return level switch
            {
                CompressionLevelEnumType.nocompression => ArchiveCompressionLevel.nocompression,
                CompressionLevelEnumType.fastest => ArchiveCompressionLevel.fastest,
                CompressionLevelEnumType.fast => ArchiveCompressionLevel.fast,
                CompressionLevelEnumType.normal => ArchiveCompressionLevel.normal,
                CompressionLevelEnumType.maximum => ArchiveCompressionLevel.maximum,
                CompressionLevelEnumType.ultra => ArchiveCompressionLevel.ultra,
