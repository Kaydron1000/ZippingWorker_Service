# ZippingWorker_Service Unit Tests
...
```bash
# Run all tests
dotnet test ZippingWorker_Service.Tests\ZippingWorker_Service.Tests.csproj

# Run with detailed output
dotnet test ZippingWorker_Service.Tests\ZippingWorker_Service.Tests.csproj --verbosity normal
