...
namespace ZippingWorkerService.Configuration
{
    ...
    {
        private const string ASSEMBLYNAME = "ZippingWorkerService";
        private const string EMBEDEDXSDNAME = "ZippingWorkerServiceConfigurationSchema.xsd";
        private List<ValidationEventArgs> _ErrorList;
        private List<ValidationEventArgs> _WarningList;
        private ZippingWorkerServiceConfigurationType _ApplicationConfiguration;
        ...
        public ZippingWorkerServiceConfigurationType ApplicationConfiguration => _ApplicationConfiguration;
        ...
        public bool ImportXml(string xmlPath)
        {
            ...
            {
                _ApplicationConfiguration = default(ZippingWorkerServiceConfigurationType);
                throw e;
            }
            try

            {
                XmlOnDeserializedSerializer serializer = new XmlOnDeserializedSerializer(typeof(ZippingWorkerServiceConfigurationType));
                _ApplicationConfiguration = (ZippingWorkerServiceConfigurationType)serializer.Deserialize(newDoc.CreateReader());
